/**
 * Shared SVG Icons — all inline SVGs used across the app.
 * Keeps icon definitions in one place.
 */
...
export function ArrowLeft({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ArrowUp({ size = 18, color = 'currentColor' }) {
  return (
...
export function LockIcon({ size = 10, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LocationPin({ size = 16, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function StarIcon({ size = 16, filled = false, color = 'currentColor' }) {
  return (
